...
router.get('/user', auth, grantAccess('readOwn', 'profile'), userController.getSingleUser);

router.get('/users', auth, grantAccess('readAny', 'profile'), userController.getUsers);
